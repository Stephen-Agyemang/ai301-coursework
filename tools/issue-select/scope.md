...
(I am strong in Python and Java, with hands-on experience building backend services, working with REST APIs, and containerizing apps with Docker. I am comfortable reading codebase documentation, navigating test suites, and handling data pipelines or algorithmic logic. For this capstone, I want to work on backend bug fixes, CLI tools, developer experience, or API integration tasks. I want to avoid frontend heavy UI/styling, CSS-heavy tasks, and open-ended, poorly documented machine learning research tickets..)
